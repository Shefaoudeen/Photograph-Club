...
const Home = () => {
  return (
    <section className="px-5">
      <div className="w-[100%] h-screen flex-1 flex items-center justify-around max-sm:flex-col ">
        <div className="w-[40%] flex flex-col max-sm:text-sm">
          <p className="text-center tracking-wide text-xl z-10">
          ...
          <div className="border-2 p-5 rounded-3xl z-10 drop-shadow-2xl mt-5 flex flex-col bg-gradient-to-tr from-white to-slate-100">
